...
class EventSpineTests(SimpleTestCase):
    ...
    def test_template_marks_each_kind_and_says_what_is_held(self):
        ...
        self.assertIn('<td class="minute">12<span class="score" title="score after the goal">1–0</span></td>', html)
        self.assertIn('<tr class="divider"><td colspan="3">half-time</td></tr>', html)
        ...
        self.assertIn('<div class="ev sub off"><span class="glyph" title="went off">', html)
        self.assertNotIn('<span class="legend">', html)
    ...
    def test_template_hides_the_score_column_and_marks_unplaced_goals(self):
        ...
        self.assertIn('<td class="minute">30</td>', html)
